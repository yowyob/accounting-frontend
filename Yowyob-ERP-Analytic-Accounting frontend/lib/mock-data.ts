...
export type ClasseAnalytique = "90" | "92" | "94" | "97";
...
export interface PeriodeAnalytique {
    ...
    exerciceId: string;
    /**
     * Lien vers la période de la CG (PeriodeCG.id).
     * Quand la période CG est clôturée, la période analytique correspondante
     * doit également être clôturée. La synchronisation se fait via ce champ.
     */
    periodeCGId: string;
}
...
export const mockComptesAnalytiques: CompteAnalytique[] = [
    ...
    { id: "c1", numero: "906061", libelle: "Charges réfléchies - Électricité", classe: "90", actif: true, description: "Miroir du compte CG 606100" },
    { id: "c2", numero: "906070", libelle: "Charges réfléchies - Achats de marchandises", classe: "90", actif: true, description: "Miroir du compte CG 607000" },
    { id: "c3", numero: "906132", libelle: "Charges réfléchies - Loyers", classe: "90", actif: true, description: "Miroir du compte CG 613200" },
    { id: "c4", numero: "906411", libelle: "Charges réfléchies - Salaires", classe: "90", actif: true, description: "Miroir du compte CG 641100" },

    // Comptes de Sections (Centres de Cuûts) (92)
    { id: "c5", numero: "921000", libelle: "Section - Direction Générale", classe: "92", actif: true, description: "Centre de structure" },
    { id: "c6", numero: "922000", libelle: "Section - Activité Vélos", classe: "92", actif: true, description: "Section opérationnelle Vélos" },
    { id: "c7", numero: "922100", libelle: "Section - Activité Trottinettes", classe: "92", actif: true, description: "Section opérationnelle Trottinettes" },
    { id: "c8", numero: "923100", libelle: "Section - Atelier Production", classe: "92", actif: true, description: "Centre de travail machine" },
...
export const mockCharges: ChargeAnalytique[] = [
    { id: "ch1", nature: "Matières premières", montant: 2500000, type: "DIRECTE", incorporable: true, centreId: "c1", periodeId: "p1" },
    { id: "ch2", nature: "Main d'œuvre directe", montant: 1800000, type: "DIRECTE", incorporable: true, centreId: "c1", periodeId: "p1" },
    { id: "ch3", nature: "Électricité", montant: 450000, type: "INDIRECTE", incorporable: true, centreId: "c4", periodeId: "p1" },
    { id: "ch4", nature: "Amortissements", montant: 320000, type: "INDIRECTE", incorporable: true, centreId: "c3", periodeId: "p1" },
    { id: "ch5", nature: "Frais de publicité", montant: 180000, type: "INDIRECTE", incorporable: true, centreId: "c2", periodeId: "p1" },
    { id: "ch6", nature: "Charges financières", montant: 95000, type: "INDIRECTE", incorporable: false, centreId: "c3", periodeId: "p1", description: "Non incorporable" },
];

/**
 * Périodes analytiques — chaque période est liée à une PeriodeCG via periodeCGId.
 * La règle métier : si periodeCG.cloturee = true → statut CA doit = "CLOTURE".
 * La synchronisation est visible dans la page Périodes (badge d'alerte si désync).
 */
export const mockPeriodes: PeriodeAnalytique[] = [
    { id: "p1", libelle: "Janvier 2026", dateDebut: "2026-01-01", dateFin: "2026-01-31", statut: "CLOTURE", exerciceId: "e1", periodeCGId: "cg-p1" },
    { id: "p2", libelle: "Février 2026", dateDebut: "2026-02-01", dateFin: "2026-02-28", statut: "CLOTURE", exerciceId: "e1", periodeCGId: "cg-p2" },
    { id: "p3", libelle: "Mars 2026", dateDebut: "2026-03-01", dateFin: "2026-03-31", statut: "EN_COURS", exerciceId: "e1", periodeCGId: "cg-p3" },
    { id: "p4", libelle: "Avril 2026", dateDebut: "2026-04-01", dateFin: "2026-04-30", statut: "OUVERT", exerciceId: "e1", periodeCGId: "cg-p4" },
    { id: "p5", libelle: "Mai 2026", dateDebut: "2026-05-01", dateFin: "2026-05-31", statut: "OUVERT", exerciceId: "e1", periodeCGId: "" },
    { id: "p6", libelle: "Juin 2026", dateDebut: "2026-06-01", dateFin: "2026-06-30", statut: "OUVERT", exerciceId: "e1", periodeCGId: "" },
];

export const mockCoutsProduits: CoutProduit[] = [
    { id: "cp1", produitCode: "PROD-A", produitLibelle: "Produit Alpha", coutAchat: 850000, coutProduction: 1450000, coutRevient: 1850000, methodeStock: "CUMP", periodeId: "p3" },
    { id: "cp2", produitCode: "PROD-B", produitLibelle: "Produit Beta", coutAchat: 620000, coutProduction: 1100000, coutRevient: 1380000, methodeStock: "FIFO", periodeId: "p3" },
    { id: "cp3", produitCode: "PROD-C", produitLibelle: "Produit Gamma", coutAchat: 490000, coutProduction: 820000, coutRevient: 1050000, methodeStock: "CUMP", periodeId: "p3" },
];
...
export const mockBudgets: BudgetAnalytique[] = [
    {
        ...
        statut: "VALIDE",
        lignes: [
            { id: "bl1", centreId: "c1", axeId: "1", nature: "Matières premières", montantBudget: 3000000, montantReel: 2500000, periodeId: "p3" },
            { id: "bl2", centreId: "c1", axeId: "1", nature: "Main d'œuvre directe", montantBudget: 2000000, montantReel: 1800000, periodeId: "p3" },
            { id: "bl3", centreId: "c2", axeId: "1", nature: "Frais de distribution", montantBudget: 600000, montantReel: 180000, periodeId: "p3" },
            { id: "bl4", centreId: "c3", axeId: "1", nature: "Frais administratifs", montantBudget: 400000, montantReel: 320000, periodeId: "p3" },
            { id: "bl5", centreId: "c4", axeId: "1", nature: "Électricité & énergie", montantBudget: 500000, montantReel: 450000, periodeId: "p3" },
            { id: "bl6", centreId: "c5", axeId: "2", nature: "Transport & logistique", montantBudget: 200000, montantReel: 0, periodeId: "p3" },
        ],
    },
    {
        id: "b2",
        ...
        statut: "REVISE",
        lignes: [
            { id: "bl7", centreId: "c1", axeId: "1", nature: "Matières premières", montantBudget: 2800000, montantReel: 2500000, periodeId: "p1" },
            { id: "bl8", centreId: "c1", axeId: "1", nature: "Main d'œuvre directe", montantBudget: 1900000, montantReel: 1800000, periodeId: "p1" },
        ],
    },
];
